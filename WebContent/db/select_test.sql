...
SELECT M.*,ONO FROM MEMBER M, ORDERS O WHERE M.MID=O.MID;
SELECT * FROM ORDERS;

INSERT INTO ORDERS VALUES(ONO_SEQ.NEXTVAL,SYSDATE,NULL,DNO_SEQ.NEXTVAL,'aaa');

SELECT * FROM DELIVERY;
INSERT INTO ORDERS (DNO,DPRICE,DCONPANY,parrive_date) VALUES(DNO_SEQ.nextval,2500,'한진',NULL);