...
public class PaymentService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		boolean mcumulative_buy_plus = mDao.mcumulative_buy_plus(purchase_amount, mid); // 6.member에 누적구매금액 증가
		boolean mPointMinus = mDao.mPointMinus(usemp, mid); //7.쓴 포인트 마이너스
